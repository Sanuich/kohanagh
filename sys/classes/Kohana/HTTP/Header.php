...
use Kohana\Text as Text;
use Kohana\Cookie as Cookie;

/**
 * The Kohana_\HTTP\Header class provides an Object-Orientated interface
...
class Header extends \ArrayObject {
	...
	/**
	 * Constructor method for [Kohana_\HTTP\Header]. Uses the standard constructor
