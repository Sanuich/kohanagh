...
class Tests {
	...
	static function suite()
	{
		...
		{
			Tests::whitelist(NULL, $suite);
		}
		
		if (count($config['blacklist']))
		{
			Tests::blacklist($config->blacklist, $suite);
		}
	 ...
	 */
	static function addTests(TestSuite $suite, array $files)
	{
	 ...
	 * @param Unittest_TestSuite $suite Suite to load the whitelist into
	 */
	static protected function set_whitelist($files, TestSuite $suite = NULL)
	{
