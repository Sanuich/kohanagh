...
namespace Kohana\Unittest\Database;

use Kohana\Core as Kohana;
use Kohana\Unittest as Unittest;
 ...
 */
abstract class TestCase extends \PHPUnit\Extensions\Database\TestCase {
	...
	{
		$this->_helpers = new Unittest\Helpers;
    ...
    {
        return \Kohana\Database::instance(Kohana::$config->load('unittest')->db_connection);
    }
	...
	{
		return Unittest\Helpers::clean_cache_dir();
	}
	...
	{
		return Unittest\Helpers::dir_separator($path);
	}
	...
	{
		return Unittest\Helpers::has_internet();
	}
