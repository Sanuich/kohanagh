...
abstract class Kohana_Controller_Userguide extends Controller_Template {
	...
	public $template = 'views\\userguide\\template';
	...
	public function index()
	{
		...
		$this->template->content = View::factory('views\\userguide\\index', array('modules' => $this->_modules()));
		$this->template->menu = View::factory('views\\userguide\\menu', array('modules' => $this->_modules()));
	...
	public function error($message)
	{
		...
		$this->template->content = View::factory('views\\userguide\\error',array('message' => $message));
	...
	public function action_api()
	{
		...
		if ( ! $class)
		{
			...
			$this->template->content = View::factory('views\\userguide\\api\\toc')
		...
		else
		{
			...
			$this->template->content = View::factory('views\\userguide\\api\\class')
				->set('doc', $_class)
				->set('route', $this->request->route());
		}
