...
use Kohana\Database\Query as Query;
use Kohana\Database\Query\Builder\Select as Select;
use Kohana\Database\Query\Builder\Insert as Insert;
use Kohana\Database\Query\Builder\Update as Update;
use Kohana\Database\Query\Builder\Delete as Delete;
