...
class TaskTest extends \Kohana\Unittest\TestCase
{
	/**
	...
	{
		$this->assertSame($expected, Task::convert_task_to_class_name($task_name));
	}
	...
	{
		$this->assertSame($expected, Task::convert_class_to_task($class));
	}
}
