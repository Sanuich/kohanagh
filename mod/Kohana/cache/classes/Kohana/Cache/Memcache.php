 ...
 */
class Memcache extends Cache implements Arithmetic {
	...
	protected function __construct(array $config)
	{
		...
		foreach ($servers as $server)
		{
			...
			{
				throw new Exception('Memcache could not connect to host \':host\' using port \':port\'', array(':host' => $server['host'], ':port' => $server['port']));
			}
		}
