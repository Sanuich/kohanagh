...
namespace Kohana\Encrypt\Engine;

use Kohana\Exception as Kohana_Exception;
 ...
 */
class Mcrypt extends \Kohana\Encrypt\Engine {
	...
	public function __construct($key_config, $mode = NULL, $cipher = NULL)
	{
		 ...
		 */
		if ((Mcrypt::$_rand !== MCRYPT_DEV_URANDOM) AND (Mcrypt::$_rand !== MCRYPT_DEV_RANDOM))
		{
			Mcrypt::$_rand = MCRYPT_DEV_URANDOM;
		}
	...
	public function create_iv()
	{
		...
		return mcrypt_create_iv($this->_iv_size, Mcrypt::$_rand);
	}
